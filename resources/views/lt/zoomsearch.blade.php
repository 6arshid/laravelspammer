@extends('layouts.app') @section('title',app('request')->zoomsearch) @section('content')
...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Top Sites</h6>
...
<div class="col-md-6">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in News</h6>
...
<div class="col-md-4">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Music</h6>
...
<div class="col-md-4">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Movie</h6>
...
<div class="col-md-4">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Sport</h6>
...
<div class="col-md-4">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Shop</h6>
...
<div class="col-md-4">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Photo</h6>
...
<div class="col-md-4">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Web</h6>
...
<div class="col-md-4">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Developer</h6>
...
<div class="col-md-4">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Finance</h6>
...
<div class="col-md-4">
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-2">Result for {{$request->zoomsearch}} in Home</h6>
